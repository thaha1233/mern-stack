...
import { FaSearch, FaUser, FaIdCard, FaCalendar, FaInfoCircle, FaPhone, FaUniversity } from "react-icons/fa";
      ...
      <div className="container mt-5">
        <Row className="mb-4">
          <Col className="text-center">
            <img id="logo-test" src={logo} alt="" />
            <h2>בדיקת תוקף התלמיד</h2>
            <h4>מומחים ברישום קבלנים PRO</h4>
            <h2>צור קשר:046335323 </h2>
          </Col>
        </Row>
